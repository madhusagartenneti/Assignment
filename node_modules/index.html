...
<body>
    <div class="container py-5">
        ...
        <div class="row pt-5 border-bottom border-secondary border-5">
            <div class="col-12 col-md-2 mb-5">
                <div>
                    <div class="mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <div class="col-12 col-md-5 border-right border-secondary border-5">
                <div>
                    <h1>MADHU SAGAR TENNETI</h1>
                    <p>Web Developer</p>
                </div>
            </div>
            <div class="col-12 col-md-5">
                <div>
                    <p>Address: Elamanchili, Andhra Pradesh</p>
                    <p>Phone: +(91) 8978394371 </p>
                    <p>Website: madhusagar.ccbp.tech </p>
                </div>
            </div>
        </div>
        <div class="row pt-5 border-bottom border-secondary border-5">
            ...
            <div class="col-12 col-md-10">
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        <div>
                            <b> Web Development ABC Company - Web Developer
                            </b>
                        </div>
                        <p>Worked on Website Application</p>
            ...
            <div class="col-12 col-md-5">
                <div class="margin-desktop">
                    ...
                    <div class="d-flex work-exp mb-3">
                        ...
                        <div>
                            <div>
                                <b> Graphic Londan Award
                                </b>
                            </div>
                            <p>Winner Entry: Poster Designer</p>
                        </div>
                    </div>
                    <div class="d-flex work-exp mb-3">
                        <div class="me-5">
                        ...
                        <div>
                            <div>
                                <b>LA Creatives Award</b>
                            </div>
                            <p>Winner Entry: Ad Campaign</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row pt-5 border-bottom border-secondary border-5">
            <div class="col-12 col-md-2 mb-5">
                <div>
                    <div class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-lightbulb-fill" viewBox="0 0 16 16">
            ...
            <div class="col-12 col-md-10 d-flex justify-content-between">
                ...
                <div>
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-film" viewBox="0 0 16 16">
                            <path d="M0 1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V1zm4 0v6h8V1H4zm8 8H4v6h8V9zM1 1v2h2V1H1zm2 3H1v2h2V4zM1 7v2h2V7H1zm2 3H1v2h2v-2zm-2 3v2h2v-2H1zM15 1h-2v2h2V1zm-2 3v2h2V4h-2zm2 3h-2v2h2V7zm-2 3v2h2v-2h-2zm2 3h-2v2h2v-2z" />
                        </svg></div>
                    <p>Movies</p>
                </div>
                <div>
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-file-music-fill" viewBox="0 0 16 16">
        ...
        <div class="row pt-5">
            ...
            <div class="col-12 col-md-10">
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        <div>
                            <b> Adikavi Nannaya University</b>
                        </div>
